...
const FooterIllustrationsV1 = (props: FooterIllustrationsProp) => {
  ...
  if (!hidden) {
    return (
      <Fragment>
        {image1 || <Tree1Img alt="tree" src="/assets/pages/auth-v1-tree.png" />}
        <MaskImg
          alt="mask"
          src={`/assets/pages/auth-v1-mask-${theme.palette.mode}.png`}
        />
        {image2 || (
          <Tree2Img alt="tree-2" src="/assets/pages/auth-v1-tree-2.png" />
        )}
      </Fragment>
    );
  } else {
