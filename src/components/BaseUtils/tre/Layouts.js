...
export const ContentWithPaddingXl= tw.div`max-w-screen-xl mx-auto py-2 lg:py-3`;
export const ContentWithPaddingXll= tw.div`max-w-screen-xl mx-auto py-20 lg:py-24`;
